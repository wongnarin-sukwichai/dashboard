<template>
                ...
                <li>
                    ...
                    >
                        <div class="side-menu__icon">
                            <box-icon name="home" color="#64748b"></box-icon>
                        </div>
                                ...
                                >
                                    <span class="flex items-center"
                                        ><box-icon
                                            ...
                                            class="mr-2"
                                        ></box-icon>
                                        Welcome to Dashboard System form
                        ...
                        >
                            ...
                            <div class="report-box-2 intro-y mt-12 sm:mt-5">
                                <div class="box sm:flex">
                                    <div
                                        class="px-8 py-12 flex flex-col justify-center flex-1"
                                    >
                                        <box-icon
                                            name="book"
                                            size="lg"
                                        ...
                                        ></box-icon>
                                        <div
                                            class="relative text-3xl font-medium mt-12 pl-4 ml-0.5"
                                        >
                                            <span
                                        ...
                                        <div
                                            class="report-box-2__indicator bg-success tooltip cursor-pointer"
                                        ...
                                        <div class="mt-4 text-slate-500">
                                            Sales earnings this month after
                                            associated author fees, & before
                                            taxes.
                                        </div>
                                        <button
                                        ...
                                        >
                                            ...
                                            >
                                            <box-icon name='right-arrow-alt' color="#cbd5e1"></box-icon>
                                            </span>
                                        </button>
                                    </div>
                                    <div
                                    ...
                                    >
                                        ...
                                        <div
                                            class="text-slate-500 text-xs mt-5"
                                        >
                                            CANCELATION CASE
                                        </div>
                                        <div class="mt-1.5 flex items-center">
                                    ...
                                    <div class="tab-content mt-6">
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                >
                                                    <div
                                                        class="w-2 h-2 bg-pending rounded-full mr-3"
                                                    ></div>
                                                    <span class="truncate"
                                                        >31 - 50 Years old</span
                                                    >
                                                    <span
                                                        class="font-medium ml-auto"
                                                        >33%</span
                                                ...
                                                <div class="flex">
                                                    ...
                                                    >
                                                        <img
                                                            ...
                                                            title="Uploaded at 24 September 2021"
                                                        />
                                                    </div>
                                                </div>
                                            </td>
                                                ...
                                                <div class="flex">
                                                    ...
                                                    >
                                                        <img
                                                            ...
                                                            class="tooltip rounded-full"
                                                            src="dist/images/preview-9.jpg"
                                                            title="Uploaded at 19 July 2021"
                                                        />
                                                    </div>
                                                </div>
                                            </td>
                                    ...
                                    <div class="intro-x box">
                                        <div class="p-5">
                                            <div class="flex">
                                                ...
                                                ></i>
                                                <div
                                                    class="font-medium text-base mx-auto"
                                                >
                                                    April
                                                </div>
                                                <i
                                            ...
                                            >
                                                ...
                                                <div
                                                    class="py-0.5 rounded relative text-slate-500"
                                                >
                                                    29
                                                </div>
                                                <div
                                                ...
                                                <div
                                                    class="py-0.5 bg-primary text-white rounded relative"
                                                >
                                                    8
                                                </div>
                                                <div
                                        ...
                                        <div
                                            class="border-t border-slate-200/60 p-5"
                                        >
                                            <div class="flex items-center">
                                                <div
                                                    class="w-2 h-2 bg-pending rounded-full mr-3"
    ...
    >
        ...
        <div
            ...
            :class="
                isDarkMode === true ? 'dark-mode-switcher__toggle--active' : ''
            "
            @click="darkMode()"
        ></div>
    </div>
            ...
            let myDoughnutChart = new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [
                        {
                            data: [15, 10, 65],
                            backgroundColor: ["#d97706", "#f59e0b", "#0d9488"],
